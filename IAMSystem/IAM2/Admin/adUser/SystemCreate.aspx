<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="SystemCreate.aspx.cs" Inherits="IAM.Admin.adUser.SystemCreate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
       ...
       // var pageStutas = "NaN";
        jQuery(document).ready(function () {
            ...
            jQuery("#usertype").change(function () {
                ...
                switch (_value) {
                    case "user": window.location.href = "./UserCreate.aspx?ut=" + _value; break
                    case "other":
                        ...
                        break;
                    case "system": window.location.href = "./systemcreate.aspx";
                }
            });
        });
    ...
    function AutoAddMail() {
        ...
        function OpenModal() {
            ...
            var _value = window.showModalDialog("ADWorkGroupManger.aspx?userid=" + jQuery("#<%=txtLoginName.Text %>").val(), null, "dialogWidth=950px;dialogHeight=670px;");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 938px;">
        ...
        <div style="float:right; margin-top: 10px; width: 430px;">
