<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="UserConfilictByUser.aspx.cs" Inherits="IAM.ConflictResolution.UserConfilictByUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pure-control-group" style="margin-top: 10px;" runat="server" id="nav_top">
        ...
        <input type="button" id="btnsystemhtml0" value="导出" class="pure-button pure-button-primary" />
                ...
                <asp:Repeater ID="repeaterUserDeferences" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 100px; cursor: pointer"><%#Eval("UserName") %></td>
