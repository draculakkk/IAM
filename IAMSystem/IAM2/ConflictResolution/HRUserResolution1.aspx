<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/master.Master"  CodeBehind="HRUserResolution1.aspx.cs" Inherits="IAM.ConflictResolution.HRUserResolution1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin: 0px; padding: 0px; width: 1376px; overflow-x: hidden; overflow-y: visible; height: 450px;">
                        ...
                        <tr>
                            <td style="width: 50px">
                             ...
                             <td style="width: 100px">
                                <a href="javascript:OpenPage('../Report/ReportByUserCode.aspx?gonghao=<%#Eval("cardNo") %>');"><%#Eval("cardNo") %></a><%--<%#Eval("cardNo")%>--%>
                            </td>
                            ...
                            <td style="width: 150px">
                                <%#GetHrPartMent(Eval("oldvalue"))%>
                            </td>
                            <td style="width: 150px">
                                <%#GetHrPartMent(Eval("newvalue")) %>
                            </td>
                            <td style="width: 150px;">
                                <%#Eval("createtime") %>
                            </td>
