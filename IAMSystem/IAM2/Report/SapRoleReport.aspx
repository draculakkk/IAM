<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="SapRoleReport.aspx.cs" Inherits="IAM.Report.SapRoleReport" %>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#btnExcelExport").bind("click", function () {
                ...
                jQuery.post("../ExcelExportAjax.ashx?type=saprole", {
                    gonghao: gonghao,
                    name: name,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        <div style="width: 1300px; margin-top: 10px;">
            <table class="pure-table pure-table-bordered" style="text-align: center; text-decoration: none; font-size: 14px; width: 1300px; table-layout: fixed;">
                <thead>
                    <tr align="center">


                        <th style="width: 230px">角色
                        </th>
                        <th style="width: 250px">角色名
                        </th>
                        <th style="width: 70px">工号
                        </th>
                        <th style="width: 125px">姓名
                        </th>
                        <th style="width: 125px">部门
                        </th>
                        <th style="width: 125px">SAP账号
                        </th>
        ...
        <div style="width: 1525px; margin: 0px; overflow-x: hidden; overflow-y: auto; height: 350px;">
            <table class="pure-table pure-table-bordered" id="testfff" style="text-align: center; text-decoration: none; font-size: 12px; width: 1300px; table-layout: fixed;">
                <tbody>
