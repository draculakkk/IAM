<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="false" CodeBehind="DifferenceReportByUserAndTemplate.aspx.cs" Inherits="IAM.Report.DifferenceReportByUserAndTemplate" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divcontext">
        <table class="pure-table pure-table-bordered" id="table3" style="text-align: center; text-decoration: none; font-size: 14px; width: 1070px;">
            <tr>
                <td colspan="3">
        ...
        <asp:Button ID="Button1" runat="server" Text="比较"
            ...
            <tr style="background-color: #efefef">
                <td style="background-color: #efefef; width: 200px">账号</td>
                <td colspan="2" style="background-color: #efefef; width: 300px">角色名</td>
                <td style="width: 30px; background-color: #efefef;"></td>
                <td style="background-color: #efefef; width: 200px">账号</td>
                <td colspan="2" style="background-color: #efefef; width: 300px">角色名</td>
            </tr>
            ...
            <tr>
                <td colspan="6" align="left">其他类</td>
            </tr>
            ...
            <tr>
                <td style="width: 70px; background-color: #efefef;">账号</td>
                <td style="background-color: #efefef; width: 200px;">角色名</td>
                <td style="background-color: #efefef; width: 200px;">公司</td>
                <td style="width: 30px; background-color: #efefef;"></td>
                <td style="width: 70px; background-color: #efefef;">账号</td>
                <td style="background-color: #efefef; width: 200px">角色名</td>
                <td style="background-color: #efefef; width: 200px">公司</td>
