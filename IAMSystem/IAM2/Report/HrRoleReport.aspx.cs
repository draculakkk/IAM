...
{
    public partial class HrRoleReport : BasePage
    {
        ...
        void BindHRUserRoleReport()
        {
            ...
            hrUserRoleList= hrUserRoleList.OrderBy(item => item.role_name).Skip((AspNetPager1.CurrentPageIndex-1)*base.PageSize).Take(base.PageSize).ToList();
