...
{
    public partial class ADUserReport : BasePage
    {
        ...
        void Bind()
        {
            ...
            listUserWorkGroup=listUserWorkGroup.OrderBy(item => item.uAccountname).Skip((AspNetPager1.CurrentPageIndex-1)*base.PageSize).Take(base.PageSize).ToList();

            repeater1ADUserGrounp.DataSource = listUserWorkGroup;
