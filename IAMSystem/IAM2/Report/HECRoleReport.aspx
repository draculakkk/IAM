<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="HECRoleReport.aspx.cs" Inherits="IAM.Report.HECRoleReport" %>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#btnExcelExport").bind("click", function () {
                ...
                jQuery.post("../ExcelExportAjax.ashx?type=hecrole",
                      {
                          gonghao: gonghao,
                          name: name,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pure-control-group" style="margin-top: 10px;" runat="server" id="nav_top">
        <table id="tablefilter">
            ...
            <tr>
                ...
                <td class="td-context-width">
                    <asp:TextBox ID="txtCompanyName" Width="150px" runat="server"></asp:TextBox>
                </td>
    ...
    <div id="divtitle" style="width: 1450px; margin-top: 10px;">
        <table class="pure-table pure-table-bordered" style="text-align: center; text-decoration: none; font-size: 14px; width: 1450px; table-layout: fixed;">
            <thead>
                <tr align="center">
    ...
    <div id="divcontext" style="width: 1701px; margin: 0px; overflow-x: hidden; overflow-y: auto; height: 400px;">
        <table class="pure-table pure-table-bordered" id="testfff" style="text-align: center; text-decoration: none; font-size: 14px; width: 1450px; table-layout: fixed;">
            <tbody>
                <asp:Repeater ID="repeater1HECUserrole" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 75px"><a href="#" onclick="javascript:OpenEmployeeinfo('<%#Eval("code") %>');"><%#Eval("code") %></a>
                            </td>

                            <td style="width: 150px"><%#Eval("dname") %>
                            </td>
                            <td style="width: 150px"><%#Eval("ename") %>
                            </td>
                            <td style="width: 150px">
                                <%#Eval("uUSERNAME")%>
                            </td>
