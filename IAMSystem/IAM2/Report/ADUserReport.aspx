<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="false" CodeBehind="ADUserReport.aspx.cs" ValidateRequest="false" Inherits="IAM.Report.ADUserReport" %>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery("#btnExcelExport").bind("click", function () {
                ...
                jQuery.post("../ExcelExportAjax.ashx?type=aduser",
                    {
                        gonghao: gonghao,
    ...
    <div class="pure-control-group" style="margin-top: 10px;" runat="server" id="nav_top">
        <table id="tablefilter">
            ...
            <tr>
                ...
                <td class="td-context-width"><asp:TextBox ID="txtEndDate" runat="server" class="Wdate" onClick="WdatePicker()"></asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td class="td-context-width"><asp:TextBox ID="txtgroupname" runat="server"></asp:TextBox></td>
        ...
        <div id="divtitle" style="margin: 0px; padding: 0px; width: 850px;">
            <table class="pure-table pure-table-bordered" style="text-align: center; text-decoration: none; font-size: 14px; width: 850px; table-layout: fixed;">
                <thead>
                    <tr align="center">
        ...
        <div id="divcontext" style="margin: 0px; padding: 0px; width: 1177px; height: 400px; overflow-x: hidden; overflow-y: auto;">
            <table class="pure-table pure-table-bordered" id="testfff" style="text-align: center; text-decoration: none; font-size: 12px; width: 850px; table-layout: fixed;">
                <tbody>
