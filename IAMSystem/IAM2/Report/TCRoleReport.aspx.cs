...
{
    public partial class TCRoleReport : BasePage
    {
        ...
        void Bind()
        {
            ...
            list = list.OrderBy(ite => ite.uUserID).Skip((AspNetPager1.CurrentPageIndex - 1) * base.PageSize).Take(base.PageSize).ToList();
