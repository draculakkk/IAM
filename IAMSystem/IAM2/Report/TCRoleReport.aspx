<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="TCRoleReport.aspx.cs" Inherits="IAM.Report.TCRoleReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--  <style type="text/css">
        table {
            ...
            table th, table td {
                border-left: 1px solid #e2e1fa; /* inner column border */
                border-right:1px solid #e2e1fa;
                border-bottom:1px solid #e2e1fa;
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery("#btnExcelExport").bind("click", function () {
                ...
                jQuery.post("../ExcelExportAjax.ashx?type=tcrole",
                    {
                        gonghao: gonghao,
                        Name: Name,
...
<asp:Button ID="btnQuery" runat="server" Text="查询" CssClass="pure-button pure-button-primary" OnClick="btnQuery_Click" />
    ...
    <div id="divtitle" style="margin-top: 10px; margin-bottom: 0px;">
        <table class="pure-table pure-table-bordered" style="text-align: center; text-decoration: none; font-size: 13px; width: 1170px; table-layout:fixed">
            <thead>
                <tr align="center">
    ...
    <div id="divcontext" style="padding: 0px; margin: 0px; overflow-x: hidden; overflow-y: auto; height: 400px; width: 1447px;">
        <table class="pure-table pure-table-bordered" style="text-align: center; text-decoration: none; font-size: 12px; width: 1170px;table-layout:fixed">
            <tbody>
                <asp:Repeater ID="repeaterTCUserInfo" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 125px; background: #efefef;"><%#IAM.BLL.Untityone.GetGroupName(Eval("urMemo").ToString()) %></td>
                            <td style="width: 125px; background: #efefef;"><%#IAM.BLL.Untityone.GetRoleName(Eval("urMemo").ToString()) %></td>
                            <td style="width: 70px; background: #efefef;">
                                <%#Eval("urGroupStatus").ToString().Equals("0")?"非活动":"活动" %>
                            </td>
                            <td style="width: 75px; background: #efefef;">
                                <a href="#" onclick="javascript:OpenEmployeeinfo('<%#Eval("mgonghao") %>');"><%#Eval("mgonghao") %></a>
                            </td>
                            <td style="width: 100px; background: #efefef;">
                                <%#Eval("uUserName") %>
                            </td>
                            <td style="width: 225px; background: #efefef;">
                                <%#Eval("dname") %>
                            </td>
                            <td style="width: 100px; background: #efefef;">
                                <%#Eval("uUserID") %>
                            ...
                            <td style="width: 75px; background: #efefef;"><%#Eval("uLicenseLevel").ToString().Equals("1")?"作者":Eval("uLicenseLevel").ToString().Equals("0")?"客户":"其他" %>
                            </td>
                            <td style="width: 70px; background: #efefef;">
                                <%#Eval("uUserStatus").ToString().Equals("0")?"活动":"非活动" %>
                            </td>
                            <td style="width: 130px; background: #efefef;">
                                <%#Eval("uLastLoginTime") %>
                            </td>
                    ...
                    <AlternatingItemTemplate>
                        <tr>
                            ...
                            <td style="width: 75px; background: #fff;">
                                <%#Eval("mUserType") %>
                            </td>
