<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="HrUserReport.aspx.cs" Inherits="IAM.Report.HrUserReport" %>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#ExportExcel").bind("click", function () {
                ...
                jQuery.post("../ExcelExportAjax.ashx?type=hrUser",
                    {
                        gonghao: _gonghao, name: _name, department: _dept, hrusername: _hrusername,
                        logintype: _logintype, rolename: _rolename, companyname: _companyname,
                        islock: _islock,gangwei:_gangwei,leixing:_leixing
                    },
                    function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table id="tablefilter">
            ...
            <tr>
                <td colspan="8" style="height:35px;padding-left:5px;vertical-align:middle;">
                    ...
                    &nbsp;&nbsp;
     <input type="button" value="导出" class="pure-button pure-button-primary" id="ExportExcel" />
                </td>
            </tr>
        </table>
    ...
    <div id="divtitle" style="margin: 0px; padding: 0px; width: 900px;">
        <table class="pure-table pure-table-bordered" style="text-align: center; text-decoration: none; font-size: 14px; width: 1550px; table-layout: fixed;">
            <thead>
                <tr align="center">
    ...
    <div id="divcontext" style="margin: 0px; padding: 0px; width: 1600px; overflow-x: hidden; overflow-y: auto; height: 400px;">
        <table class="pure-table pure-table-bordered" id="testfff" style="width: 1550px; table-layout: fixed; text-align: center; text-decoration: none; font-size: 12px;">
            <tbody>
