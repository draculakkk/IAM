namespace RazorEngine
{
    ...
    public static class Razor
    {
        ...
        public static string Parse<T>(string template, T model, Type modelType, string name = null)
        {
            return DefaultTemplateService.Parse<T>(template, model, modelType, name);
        }
